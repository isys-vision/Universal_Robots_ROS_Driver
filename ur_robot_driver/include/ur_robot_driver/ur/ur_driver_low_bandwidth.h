 ...
 */
//----------------------------------------------------------------------
#ifndef UR_RTDE_DRIVER_UR_UR_DRIVER_LOW_BANDWIDTH_H_INCLUDED
#define UR_RTDE_DRIVER_UR_UR_DRIVER_LOW_BANDWIDTH_H_INCLUDED
...
#include "ur_robot_driver/ros/action_server.h"
...
public:
   ...
   */
  UrDriverLowBandwidth(const std::string& robot_ip, std::vector<std::string> joint_names, const std::string& script_file, const std::string& output_recipe_file,
  ...
  UrDriverLowBandwidth(const std::string& robot_ip, std::vector<std::string> joint_names, const std::string& script_file, const std::string& output_recipe_file,
    ...
    : UrDriverLowBandwidth(robot_ip, joint_names, script_file, output_recipe_file, input_recipe_file, handle_program_state, headless_mode,
...
#endif  // ifndef UR_RTDE_DRIVER_UR_UR_DRIVER_LOW_BANDWIDTH_H_INCLUDED
